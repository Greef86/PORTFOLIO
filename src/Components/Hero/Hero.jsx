...
const Hero = () => {
	return (
		<div id='home' className='hero'>
			...
			<p>I have no official work experience but 3 years of experience building websites for my business friends and myself, I graduated from <strong><a className='nwu' target='blank' href="https://www.nwu.ac.za/">North West University</a></strong> on the 20th of May 2024 with <strong style={{ whiteSpace: "nowrap" }}>Computer Science and Electronics.</strong></p>
		</div>
	)
}
